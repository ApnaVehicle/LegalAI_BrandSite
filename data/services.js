...
export const ligitServices = [
  {
    number: "01",
    title: "The Oracle",
    tagline: "Ask once. Know everything.",
    text: "Skip the endless scrolling. Our AI reads through millions of judgments instantly, connecting dots humans miss. It's like having the Supreme Court library in your pocket — but faster."
  },
  {
    number: "02",
    title: "The Time Machine",
    tagline: "Chaos to chronology in 30 seconds flat.",
    text: "Upload any case bundle. Watch as dates, events, and milestones arrange themselves perfectly. What took paralegals days now takes seconds. Your judge will think you're magic."
  },
  {
    number: "03",
    title: "The Polyglot",
    tagline: "Every Indian language. Zero lost in translation.",
    text: "From Tamil affidavits to Bengali contracts — our AI doesn't just translate words, it preserves legal intent. Because 'vakalatnama' isn't just 'power of attorney.'"
  }
];
